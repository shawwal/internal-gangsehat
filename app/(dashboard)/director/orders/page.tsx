      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            {scope === 'branch' ? 'Pantau order di cabang Anda' : 'Pantau seluruh order dari semua cabang'}
          </p>
        </div>
        <div className="flex items-center gap-2 shrink-0">
          ...
          {/* View-only for branch-scoped (therapist) viewers — creating/editing
              orders stays an admin-equivalent action, unchanged from today. */}
          {scope !== 'branch' && (
            <Link
