...
// All routes are fully English. Icon names map to Lucide React components.

export interface NavItem {
  /** Translation key for the display label (nav.*) */
  key: string
  /** URL path */
  href?: string
  /** Lucide icon name */
  icon: string
  /** Roles that can see this item — undefined means all authenticated users */
  roles?: string[]
