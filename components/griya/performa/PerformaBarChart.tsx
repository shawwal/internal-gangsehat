...
export function PerformaBarChart({ data }: Props) {
    ...
    <div className="glass-card p-5">
      ...
      <ResponsiveContainer width="100%" height={280}>
        <BarChart data={chartData} margin={{ top: 20, right: 8, left: -24, bottom: 0 }} barCategoryGap="32%">
          <defs>
            <linearGradient id="performa-bar" x1="0" y1="0" x2="0" y2="1">
          ...
          <Bar dataKey="total" name="Total Sesi" fill="url(#performa-bar)" radius={[6, 6, 0, 0]} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  )
