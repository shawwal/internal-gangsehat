...
import type { LeaveFilters, BranchOption, StatusFilter } from './types'
...
interface Props {
  ...
  pendingCount: number
  onChange: (filters: LeaveFilters) => void
}
...
export function LeaveFilters({ filters, branches, pendingCount, onChange }: Props) {
