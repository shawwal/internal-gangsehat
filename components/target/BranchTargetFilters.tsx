...
import type { BranchTargetFilters, BranchOption, StatusFilter } from './types'
import { MONTHS } from './types'

interface Props {
  filters: BranchTargetFilters
  branches: BranchOption[]
  pendingCount: number
  isManager: boolean
  onChange: (filters: BranchTargetFilters) => void
}
...
export function BranchTargetFilters({ filters, branches, pendingCount, isManager, onChange }: Props) {
  return (
