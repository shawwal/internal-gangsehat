// src/locales/en.ts
// English is the DEFAULT locale. All translation keys are defined here.
// The Indonesian locale (id.ts) mirrors this structure exactly.
...
const en = {
  ...
  status: {
    ...
    approved: 'Approved',
    rejected: 'Rejected',
    // Raw DB values mapped to display labels
